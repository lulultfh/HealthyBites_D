...
$orders_query = "SELECT o.id, o.created_at, o.total_amount, os.status 
                  FROM orders o
                  LEFT JOIN (
    ...
    <div class="container py-5">
                    ...
                    <tbody class="bg-light">
                        <?php while ($order = $orders->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-<?= $order['status'] == 'completed' ? 'dark' : ($order['status'] == 'shipped' ? 'primary' : ($order['status'] == 'processing' ? 'warning' : 'secondary')) ?>">
                                        <?= ucfirst($order['status']) ?>
                                    </span>
                                </td>
                                <td>
                                    <a href="order_details.php?order_id=<?= $order['id'] ?>" class="btn btn-sm btn-outline-primary">View</a>
                                    <?php if ($order['status'] == 'delivered'): ?>
                                        <a href="add_testimonial.php?order_id=<?= $order['id'] ?>" class="btn btn-sm btn-outline-success ms-1">Add Testimonial</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endwhile; ?>
        ...
        <?php else: ?>
            <div class="text-center py-5">
                <h2 class="mb-4">No Orders Found</h2>
